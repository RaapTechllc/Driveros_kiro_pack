...
| `doc-smith` | Documentation, READMEs, API docs | **Opus 4.5** |
| `frontend-designer` | UI/UX, accessibility, styling | **Opus 4.5** |
| `research-analyst` | Web research, docs lookup, version checking | **Opus 4.5** |
...
- `@research` - Web research for technical questions
