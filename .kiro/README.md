...
This template assumes agents work in isolated git worktrees to avoid conflicts.
...
`.kiro` folder focused on the current orchestration template and use the hackathon
docs to show the project evolution.
...
- [Template Evolution](docs/template-evolution.md) - Hackathon origins and current template lineage
