...
run_review_template() {
  ...
  run_p_thread "initial-review" "security-specialist,test-architect,performance-engineer" || true
...
run_deploy_template() {
  ...
  # Post-deploy monitoring (L-Thread)
  echo ""
  echo "=== Phase 3: Post-Deploy Monitoring ==="
  run_l_thread "monitoring" "monitoring-specialist" 2 || true
}
